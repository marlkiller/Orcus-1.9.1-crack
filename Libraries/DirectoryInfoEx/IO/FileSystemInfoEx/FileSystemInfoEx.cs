...
namespace System.IO
{
        ...
        IEquatable<FileSystemInfoEx>
    {
        ...
        private bool _parentInited;
        private PIDL _pidl;
        private PIDL _pidlRel;
        ...
        {
            Threading.Interlocked.Increment(ref counter);
        }
        ...
        public object Clone()
        {
            return new FileSystemInfoEx(FullName);
        }
        ...
        private static FileAttributes loadAttributes(IShellFolder2 iShellFolder, PIDL pidlFull, PIDL pidlRel)
        {
            ...
            ShellAPI.SFGAO attribute = ShellAPI.SFGAO.READONLY | ShellAPI.SFGAO.FOLDER | ShellAPI.SFGAO.FILESYSTEM |
                                       ShellAPI.SFGAO.STREAM | ShellAPI.SFGAO.FILESYSANCESTOR;
            iShellFolder.GetAttributesOf(1, new[] {pidlRel.Ptr}, ref attribute);
                ...
                //0.13: Fixed All subdirectory under User/Shared directory uses GUID now.
                {
                    if (DirectoryInfoEx.CurrentUserDirectory != null)
                    {
                        if (parseName == DirectoryInfoEx.CurrentUserDirectory.FullName &&
                            loadName(parentShellFolder, ShellAPI.SHGNO.FORPARSING) ==
        ...
        protected void init(PIDL fullPIDL)
        {
            ...
            _pidl = new PIDL(fullPIDL, false);
                //0.14 : FileSystemInfoEx record the pidl when construct, as some path do not parasable (e.g. EntireNetwork)
            _pidlRel = relPIDL;
        }
