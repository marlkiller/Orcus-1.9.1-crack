...
namespace ShellLibrary.Native
{
    ...
    public sealed class PropVariant : IDisposable
    {
        ...
        [FieldOffset(8)] byte _byte;

        [FieldOffset(0)] decimal _decimal;

        [FieldOffset(8)] double _double;

        [FieldOffset(8)] float _float;

        [FieldOffset(8)] Int32 _int32;

        [FieldOffset(8)] long _long;

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability",
            "CA2006:UseSafeHandleToEncapsulateNativeResources")] [FieldOffset(8)] IntPtr _ptr;
        ...
        // architectures.
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability",
            "CA2006:UseSafeHandleToEncapsulateNativeResources")] [FieldOffset(12)] IntPtr _ptr2;

        [FieldOffset(8)] sbyte _sbyte;

        [FieldOffset(8)] short _short;

        [FieldOffset(8)] UInt32 _uint32;

        [FieldOffset(8)] ulong _ulong;

        [FieldOffset(8)] ushort _ushort;

        // This is actually a VarEnum value, but the VarEnum type
        // requires 4 bytes instead of the expected 2.
        [FieldOffset(0)] ushort _valueType;
        ...
        {
            get { return (_valueType == (ushort) VarEnum.VT_EMPTY || _valueType == (ushort) VarEnum.VT_NULL); }
        }
