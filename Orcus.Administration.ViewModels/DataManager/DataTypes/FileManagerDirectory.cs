...
{
    public class FileManagerDirectory : IDataManagerType
    {
        ...
        public void ModifyDownloadedFile(string fileName)
        {
            ...
            directory.Create();
            ZipFile.ExtractToDirectory(tempPath, directory.FullName);
        ...
        public Guid DataTypeGuid { get; } = DataMode.ZipArchive.Guid;
